...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { amount: @order_line.amount, placed_order_id: @order_line.placed_order_id, product_id: @order_line.product_id }
    end
  ...
  test "should update order_line" do
    patch :update, id: @order_line, order_line: { amount: @order_line.amount, placed_order_id: @order_line.placed_order_id, product_id: @order_line.product_id }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
